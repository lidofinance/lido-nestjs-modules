...
export type IntegerFromStringNonNegative = z.infer<
  typeof IntegerFromStringNonNegative
>;
 ...
 * Possible values: 0...N (2^53-1)
 */
export const BlockNumber = z.union(
  [IntegerNonNegative, IntegerFromStringNonNegative],
  {
 ...
 * Possible values: 0...N (2^53-1)
 */
export const ValidatorIndex = z.union(
  [IntegerNonNegative, IntegerFromStringNonNegative],
  {
 ...
 * Possible values: 0...N (2^53-1)
 */
export const BlockTimestamp = z.union(
  [IntegerNonNegative, IntegerFromStringNonNegative],
  {
